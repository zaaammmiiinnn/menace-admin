  ...
  private seedInitialData() {
    ...
    this.tables.settings = [
      ...
      { key: 'staff_roles', value: JSON.stringify([
        { email: 'staff@menace.store', role: 'staff', name: 'Staff Associate' },
        { email: 'ops@menace.store', role: 'staff', name: 'Operations Lead' },
        { email: 'zamin@menace.store', role: 'admin', name: 'Zamin Askari' }
      ]), updated_at: 1789200000000 },
    ];
